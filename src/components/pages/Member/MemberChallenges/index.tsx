...
import { useGetMemberChallengesQuery } from "@/store/api/member/query";
...
const MemberChallengesPage = () => {
  ...
  // get member challenges data from API
  const { data: memberChallenges, isLoading: memberChallengesLoading } =
  ...
  return (
    <CardListingLayout
      isLoading={memberChallengesLoading}
      filterInitialValues={{
      ...
      paginationMeta={{
        ...
        totalPages: Number(memberChallenges?.pageCount),
        pageSize: Number(filterParams.PerPage),
        onPageChange: handlePageChange,
        onPageSizeChange: handlePageSizeChange,
        totalItems: Number(memberChallenges?.resultCount),
      }}
    >
      <ChallengesList challengesCards={memberChallenges?.items || []} />
    </CardListingLayout>
  );
};
