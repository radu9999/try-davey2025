...
export default function TwoUser({
  stroke = "black",
  ...props
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M16.4832 10.8816C18.0842 10.6566 19.3172 9.2826 19.3202 7.6196C19.3202 5.9806 18.1252 4.6206 16.5582 4.3636"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="M18.5955 14.7322C20.1465 14.9632 21.2295 15.5072 21.2295 16.6272C21.2295 17.3982 20.7195 17.8982 19.8955 18.2112"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
